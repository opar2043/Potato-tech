...
//           </div>
//           <div>
//             <button onClick={reset} className="btn w-full  btn-outline">Reset All</button>
//           </div>
//         </div>
//       </div>

// {  filterItem ? <p className="text-center text-col font-semibold">No Items Yet !</p> :   <div className="grid gap-6 grid-cols-2 md:grid-cols-4 ">
